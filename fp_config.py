    ...
    def config(self, site, toolType=None):
        ...
        self.pathConfig={
            ...
            'ZH1':{
                ...
                'net_step': 'net',
                'output_ipc_path_network': '\\\\10.7.10.251\\Product\\02-TEST\\ZH1-盛鑫自动化',
                'output_tgz_path_network': '\\\\10.7.10.251\\Product\\02-TEST\\ZH1-盛鑫自动化',
                'output_ipc_path': 'D:\\data',
                'output_tgz_path': 'D:\\data',
            },
            'ZH2':{
                ...
                'org': 'd:\\',
                'net_step': 'net',
                'output_ipc_path_network': '\\\\10.13.18.6\\zh2test\\测试课\\ZH2-盛鑫自动化',
                'output_tgz_path_network': '\\\\10.13.18.6\\zh2test\\测试课\\ZH2-盛鑫自动化',
                'output_ipc_path': 'D:\\data',
                'output_tgz_path': 'D:\\data',
            }
        }
